...
class User(UserMixin,db.Model):
    ...
    # comments = db.(Background on this error at: https://sqlalche.me/e/14/e3q8)(Background on this error at: https://sqlalche.me/e/14/e3q8)ionship('Comment',backref = 'user',lazy = "dynamic")
